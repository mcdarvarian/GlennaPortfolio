const proj1 = {
    ...
    short: `For the town of Arbor Rest, the last evening of winter will not end. When Nivera, a magically-inclined detective, comes into town, she can't help but feel that there is soething that she can do about it. Using her nature-based magic and quick wit, Nivera must unravel the mystery and help spring finally come. `,
    long: 

`<i>In the town of Arbor Rest, the sun no longer sets. It hangs halfway below the horizon, bathing the forest village in an eerie, red glow. The townspeople have all but resigned themselves to their fate of being stuck in the last gasp of winter. That is, until a strange traveller comes to town.<i>

HEADD The Short Version
For my college capstone project, I wore a lot of hats. My contributions included:
    
BUMPP    • Acting as a producer to keep the project focused and my team on track. 
BUMPP    • Developing a fantasy/noir narrative and characters and writing branching dialog trees. 
BUMPP    • Creating 3D environment assets, procedural textures, and shaders. 
